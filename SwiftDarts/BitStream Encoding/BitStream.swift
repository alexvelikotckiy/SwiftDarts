...
struct WritableBitStream {
    ...
    mutating func appendUInt64(_ value: UInt64) {
        appendUInt64(value, numberOfBits: value.bitWidth)
    }
    ...
    mutating func appendUInt64(_ value: UInt64, numberOfBits: Int) {
        var tempValue = value
        for _ in 0..<numberOfBits {
            appendBit(UInt8(tempValue & 1))
            tempValue >>= 1
...
struct ReadableBitStream {
    ...
    mutating func readUInt64() throws -> UInt64 {
        var result: UInt64 = 0
        do {
            result = try readUInt64(numberOfBits: UInt64.bitWidth)
        } catch let error {
            throw error
        }
        return result
    ...
    mutating func readUInt64(numberOfBits: Int) throws -> UInt64 {
        ...
        for index in 0..<numberOfBits {
            bitPattern |= (UInt64(readBit()) << index)
        }
