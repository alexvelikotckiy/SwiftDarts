...
class NetworkSession: NSObject {
    ...
    init(myself: Player, asServer: Bool, host: Player) {
        self.myself = myself
        self.session = MCSession(peer: myself.peerID, securityIdentity: nil, encryptionPreference: .none)
    ...
    func startAdvertising() {
        ...
        let discoveryInfo: [String: String] = [SwiftDartsGameAttribute.appIdentifier: appIdentifier]
        let advertiser = MCNearbyServiceAdvertiser(peer: myself.peerID,
                                                   discoveryInfo: discoveryInfo,
                                                   serviceType: SwiftDartsGameService.playerService)
