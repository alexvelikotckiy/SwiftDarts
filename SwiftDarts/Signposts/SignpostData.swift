...
extension OSLog {
    ...
    static let preload_assets = OSLog(subsystem: "SwiftDarts", category: "Preload")
    static let setup_level = OSLog(subsystem: "SwiftDarts", category: "LevelSetup")
    static let render_loop = OSLog(subsystem: "SwiftDarts", category: "RenderLoop")
    static let network_data_sent = OSLog(subsystem: "SwiftDarts", category: "NetworkDataSent")
    static let network_data_received = OSLog(subsystem: "SwiftDarts", category: "NetworkDataReceived")
}
