...
struct CollisionMask: OptionSet {
    ...
    static let board = CollisionMask(rawValue: 1)
    static let projectile = CollisionMask(rawValue: 2)
    static let phantom = CollisionMask(rawValue: 4)    // for detecting collisions with trigger volumes
    static let triggerVolume = CollisionMask(rawValue: 32)  // trigger behavior without affecting physics
}
